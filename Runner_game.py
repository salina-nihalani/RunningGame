...
pygame.display.set_caption("CityScroller_Snihalani")
...
player= RunnerSprite("Emoji.gif")
FRONT_SCROLLER_COLOR = (0,0,30)
MIDDLE_SCROLLER_COLOR = (30,30,100)
BACK_SCROLLER_COLOR = (50,50,150)
BACKGROUND_COLOR = (243, 89, 128)
...
font = pygame.font. SysFont("Gill Sans", 50, True, False)
score= 0
lives= 5
# -------- Main Program Loop -----------
...
while not done:
	...
	if lives<1:
		empty()
		GAME_OVER = font.render("Loser!!! Score: " +str(score) , True, (255,0,0))
		screen.blit(GAME_OVER, [350,150])
	if lives>1 and score is 50:
		empty()
		YOU_WIN = font.render("You Win! Score: " +str(score) , True, (255,0,0))
		screen.blit(YOU_WIN, [350,150])
